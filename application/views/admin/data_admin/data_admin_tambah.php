                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Kode Admin :</label>
                      <input type="text" class="form-control" id="" value="<?= $admin_kode ?>" placeholder="" name="admin_kode" readonly="" required>
                  </div>

                  <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Nama :</label>
                      <input type="text" class="form-control" id="" name="admin_nama" placeholder="Masukkan Nama"  required>
                  </div>
                  <div class="form-group">
                    <label for="inputPassword3" class="col-sm-4 control-label">Password</label>
                      <input type="password" class="form-control" name="admin_password" id="inputPassword3" placeholder="Masukkan Password" required>
                  </div>
